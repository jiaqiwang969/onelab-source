...
DefineConstant[
  ...
  Flag_o2_interp              = {0         , Name StrCat[pp3, "2Second order interpolation?"] , Choices {0,1}},
  Flag_o2_geom                = {0         , Name StrCat[pp3, "3Second order mesh?"] , Choices {0,1}, Visible 0},
  paramaille                  = {25 , Name StrCat[pp3, "4nb of mesh elements per wavelength [-]"   ] , ReadOnly 0, Highlight Str[colorpp]},
  ...
  paramaille_scale_rods       = {9  , Name StrCat[pp3, "6Custom mesh parameters/refine rods [-]"       ] , ReadOnly 0, Highlight Str[colorpp], Closed 1},
